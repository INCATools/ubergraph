...
- `http://reasoner.renci.org/ontology/closure` — The transitive reflexive subclass closure only, no existential relations (may be removed, since these triples are all in `http://reasoner.renci.org/redundant`).
